        ...
        <b-menu-list>
          ...
          <b-menu-item
            ...
            <template
              slot="label"
              slot-scope="props">
              <span class="side-bar-text">{{ $t('webapp.menu.test') }}</span>
              <b-icon
                :icon="props.expanded ? 'caret-down' : 'caret-up'"
                class="is-pulled-right"/>
            </template>
          ...
          <b-menu-item
            ...
            <template
              slot="label"
              slot-scope="props">
              <span class="side-bar-text">{{ $t('webapp.menu.translation') }}</span>
              <b-icon
                :icon="props.expanded ? 'caret-down' : 'caret-up'"
                class="is-pulled-right"/>
            </template>
          ...
          <b-menu-item
            ...
            <template
              slot="label"
              slot-scope="props">
              <span class="side-bar-text">{{ $t('webapp.menu.settings') }}</span>
              <b-icon
                :icon="props.expanded ? 'caret-down' : 'caret-up'"
                class="is-pulled-right"/>
            </template>
...
import BothubIcon from '@/assets/icons/botinho.svg';

export default {
  name: 'SideBar',
  components: { CustomIcon, BothubIcon },
  data() {
    return {
