...
ARG BOTHUB_WEBAPP_AUTH_PREFIX
ARG BOTHUB_WEBAPP_IFRAME_LOGIN
...
ENV BOTHUB_WEBAPP_AUTH_PREFIX "${BOTHUB_WEBAPP_AUTH_PREFIX}"
ENV BOTHUB_WEBAPP_IFRAME_LOGIN "${BOTHUB_WEBAPP_IFRAME_LOGIN}"
